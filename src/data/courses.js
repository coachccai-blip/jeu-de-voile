...
export const COURSES = [
  {
    ...
    intro: 'Saint-Tropez ! Rosé, paillettes et près serré… Gardez les mains sur le foil, pas sur le pastis ! 🥂',
  ...
  },
  {
    ...
    intro: 'Sydney ! Ça souffle à décoiffer un koala. Accrochez votre casquette ET vos tables de multiplication ! 🦘',
  ...
  },
  {
    ...
    intro: 'San Francisco ! Le courant tire plus fort que votre connexion wifi. Calculez vite… ou finissez sous le pont ! 🌉',
  ...
  },
  {
    ...
    intro: 'Dubaï ! Mer plate, chrono à fond et budget illimité : ici on double la mise ET les additions ! 💰',
  ...
  },
  {
    ...
    intro: 'Auckland ! Le vent change d\'avis plus souvent qu\'un jury de régate. Restez malins, moussaillons ! 🐑',
  ...
  },
  {
    ...
    intro: 'Marseille ! Le mistral pousse fort, comme l\'accent. Peuchère, tenez bon la barre… et les retenues ! ⚓',
