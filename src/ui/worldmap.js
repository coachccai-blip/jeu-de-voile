...
const CONTINENTS = [
  ...
  // Australie (bord est étendu pour que Sydney tombe sur la côte)
  [[0.795,0.635],[0.855,0.622],[0.905,0.648],[0.928,0.692],[0.888,0.728],[0.83,0.722],[0.788,0.685],[0.78,0.655]],
];
...
const ISLANDS = [
  ...
  [0.965,0.715,0.016], // Nouvelle-Zélande (près d'Auckland)
